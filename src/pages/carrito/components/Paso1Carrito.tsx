// src/pages/.../carrito/components/Paso1Carrito.tsx
    ...
    <div className="max-w-2xl mx-auto flex flex-col items-center w-full">
      ...
      <div className="w-full space-y-6">
          ...
          {cartItems.map((item) => (
            <div key={item.id} className="p-4 md:p-6 flex justify-between items-center bg-[#1a1a1a] border-b border-neutral-800 last:border-b-0">
              <div>
                ...
                <p className="text-neutral-400 mt-1">$ {Number(item.precioArs || 0).toLocaleString('es-AR')}</p>
              </div>
        ...
        <div className="pt-6 space-y-3">
          ...
          <div className="flex justify-between text-sm text-neutral-300">
            <span>Costo del servicio (15%):</span>
            <span>$ {costoServicio.toLocaleString('es-AR')}</span>
          </div>
