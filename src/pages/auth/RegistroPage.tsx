...
export const RegistroPage = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen lg:overflow-hidden flex flex-col lg:flex-row bg-bg-card font-sans">
      ...
      <div className="w-full lg:w-1/2 h-72 lg:h-full bg-cover bg-center grayscale shrink-0" style={{ backgroundImage: `url('https://res.cloudinary.com/dmp7mcwie/image/upload/v1773958271/flex-studio/categorias/vobkeubvl47zuy4teaek.jpg')`}}>
