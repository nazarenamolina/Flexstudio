  ...
  return (
    <footer className="bg-[#161616] pt-15 text-[#cdcdcd]">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-20 px-5 md:flex-row md:items-start md:justify-between md:px-1">
        ...
        {/* Columna 1: Logo */}
       <article className="flex shrink-0 flex-col items-center md:items-start">
          <img 
            src="https://res.cloudinary.com/dmp7mcwie/image/upload/v1774490155/logofooter_u3j6cz.png" 
            className="w-36 sm:w-40 md:w-48 lg:w-56 object-contain opacity-90 transition-opacity hover:opacity-100" 
